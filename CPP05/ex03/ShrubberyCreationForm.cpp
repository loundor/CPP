...
/*   Updated: 2022/12/15 12:37:48 by stissera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("NONAME", 145, 137), _target("NONAME")
{
	std::cout << "Shrubbery constructor with NONAME called." << std::endl;
}

ShrubberyCreationForm::ShrubberyCreationForm(std::string const& name) : Form(name, 145, 137), _target(name)
{
...
{
	std::ofstream	file;
	file.open(this->_target + "_shrubbery", std::ofstream::out | std::ofstream::app);
	file << "     ccee88oo\n";
